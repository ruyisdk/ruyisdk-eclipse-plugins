...
public class XdgDirs {
  ...
  /**
   * 获取 XDG 配置目录（ {@code $XDG_CONFIG_HOME/<app-name>} 或 {@code ~/.config/<app-name>} ）.
   */
  ...
  /**
   * 获取 XDG 缓存目录（ {@code $XDG_CACHE_HOME/<app-name>} 或 {@code ~/.cache/<app-name>} ）.
   */
  ...
  /**
   * 获取 XDG 数据目录（ {@code $XDG_DATA_HOME/<app-name>} 或 {@code ~/.local/share/<app-name>} ）.
   */
  ...
  /**
   * 获取 XDG 状态目录（ {@code $XDG_STATE_HOME/<app-name>} 或 {@code ~/.local/state/<app-name>} ）.
   */
