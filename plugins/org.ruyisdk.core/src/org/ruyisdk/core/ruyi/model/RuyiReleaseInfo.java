 ...
 *
 * <p>
 * Contains metadata about a specific RuyiSDK release including version number, release channel,
 * distribution file information, and download URLs.
 */
public class RuyiReleaseInfo {
    ...
    /**
     * The release channel. Determines update frequency and stability level.
     */
    ...
    /**
     * The GitHub download URL for this release. Primary download source for most users.
     */
    ...
    /**
     * Gets the distribution filename.
     *
     * @return the filename
     */
